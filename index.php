			...
			<div class="container">
				<div class="row row-sm mb-lg">
					<div class="col-md-9 col-md-push-3">
						<div class="slider-container rev_slider_wrapper" style="height: 373px;">
						...
						<div class="home-side-menu-container">
							...
							<ul class="home-side-menu">
													...
													<div class="col-md-7">
														<div class="row">
															...
															<div class="col-md-6">
																...
																<ul class="dropdown-mega-sub-nav">
																	<li><a href="#">Accessories</a></li>
																	<li><a href="#">Watch Fashion<span class="tip tip-new">New</span></a></li>
														...
														<div class="row">
															<div class="col-md-6">
																<a href="#" class="dropdown-mega-sub-title">Jewellery<span class="tip tip-hot">Hot!</span></a>
																<ul class="dropdown-mega-sub-nav">
															...
															<div class="col-md-6">
																<a href="#" class="dropdown-mega-sub-title">Kids Fashion</a>
																<ul class="dropdown-mega-sub-nav">
														...
														<div class="row">
															<div class="col-md-4">
																...
																<ul class="dropdown-mega-sub-nav">
																	...
																	<li><a href="#">Home Office Equipments</a></li>
																	<li><a href="#">GPS Navigation</a></li>
																	<li><a href="#">Car Video, Audio &amp; GPS</a></li>
																	<li><a href="#">Radios &amp; Clock Radios</a></li>
																</ul>
															</div>
															<div class="col-md-4">
																...
																<ul class="dropdown-mega-sub-nav">
																	...
																	<li><a href="#">Samsung Galaxy Phones</a></li>
																	<li><a href="#">iPad &amp; Android Tablets</a></li>
																</ul>
															</div>
															<div class="col-md-4">
																...
																<ul class="dropdown-mega-sub-nav">
																	...
																	<li><a href="#">Video Games &amp; Consolers</a></li>
																	<li><a href="#">Printers &amp; Scanners</a></li>
																	<li><a href="#">Digital Picture Frames</a></li>
																	<li><a href="#">3D Fashion Games</a></li>
																	<li><a href="#">Game Machine &amp; Devices</a></li>
																</ul>
															</div>
														</div>
													</div>
								...
								<li class="dropdown-full-color dropdown-primary">
									<a href="#">
										Pages <i class="fa fa-caret-right"></i>
									</a>
									<ul class="dropdown-menu">
										<li class="dropdown-submenu">
											<a href="#">Category <i class="fa fa-caret-right"></i></a>
											<ul class="dropdown-menu">
												<li><a href="demo-shop-6-category-2col.html">Category - 2 Columns</a></li>
												<li><a href="demo-shop-6-category-3col.html">Category - 3 Columns</a></li>
												<li><a href="demo-shop-6-category-4col.html">Category - 4 Columns</a></li>
												<li><a href="demo-shop-6-category-5col.html">Category - 5 Columns</a></li>
												<li><a href="demo-shop-6-category-6col.html">Category - 6 Columns</a></li>
												<li><a href="demo-shop-6-category-7col.html">Category - 7 Columns</a></li>
												<li><a href="demo-shop-6-category-8col.html">Category - 8 Columns</a></li>
												<li><a href="demo-shop-6-category-list.html">Category - List</a></li>
												<li><a href="demo-shop-6-category-right-sidebar.html">Rigt Sidebar</a></li>
											</ul>
										</li>
										<li class="dropdown-submenu">
											<a href="#">Category Banners <i class="fa fa-caret-right"></i></a>
											<ul class="dropdown-menu">
												<li><a href="demo-shop-6-category-banner-boxed-slider.html">Boxed Slider</a></li>
												<li><a href="demo-shop-6-category-banner-boxed-image.html">Boxed Image</a></li>
												<li><a href="demo-shop-6-category-banner-fullwidth.html">Fullwidth Image</a></li>
											</ul>
										</li>
										<li class="dropdown-submenu">
											<a href="#">Product Details <i class="fa fa-caret-right"></i></a>
											<ul class="dropdown-menu">
												<li><a href="demo-shop-6-product-details.html">Product Details</a></li>
												<li><a href="demo-shop-6-product-details2.html">Product Details 2</a></li>
												<li><a href="demo-shop-6-product-details3.html">Product Details 3</a></li>
												<li><a href="demo-shop-6-product-details4.html">Product Details 4</a></li>
											</ul>
										</li>
										<li><a href="demo-shop-6-cart.html">Shopping Cart</a></li>
										<li><a href="demo-shop-6-checkout.html">Checkout</a></li>
										<li><a href="demo-shop-6-about-us.html">About Us</a></li>
										<li class="dropdown-submenu">
											<a href="#">Dashboard <i class="fa fa-caret-right"></i></a>
											<ul class="dropdown-menu">
												<li><a href="demo-shop-6-dashboard.html">Dashboard</a></li>
												<li><a href="demo-shop-6-myaccount.html">My Account</a></li>
											</ul>
										</li>
										<li class="dropdown-submenu">
											<a href="#">Login &amp; Register  <i class="fa fa-caret-right"></i></a>
											<ul class="dropdown-menu">
												<li><a href="demo-shop-6-login.html">Login</a></li>
												<li><a href="demo-shop-6-register.html">Register</a></li>
											</ul>
										</li>
										<li>
											<a href="#" class="dropdown-toggle">
												Blog  <i class="fa fa-caret-right"></i>
											</a>
											<ul class="dropdown-menu">
												<li><a href="demo-shop-6-blog.html">Blog</a></li>
								...
								<li>
									<a href="demo-shop-6-contact-us.html">
